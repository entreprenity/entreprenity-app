								...
								<table cellpadding="0" cellspacing="0">
											...
											<table cellpadding="0" cellspacing="0">
												<tr>
													<td align="center" style="padding-left: 10px;  padding-right: 10px;">
														<h1 style="font-size: 18px;">Welcome to Entreprenity <strong class="name" style="color: #f29b13;">@will</strong>!</h1>
														<p>Confirm your email address to start meeting fellow entreprenuers.</p>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td align="center" style="height: 50px; padding-left: 10px;  padding-right: 10px; padding-bottom: 20px;">
											<span style="color: #f29b13; padding-top: 10px; padding-bottom: 10px; padding-left: 10px; padding-right: 10px; border-color: #f29b13; border-width: 2px; border-style: solid; cursor: pointer;"><a href="#" style="color: inherit; text-decoration: none;">Confirm your email address</a></span>
										</td>
									</tr>																						
									<tr>
